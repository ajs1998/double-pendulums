...
<div>
    ...
    <footer class="footer footer-horizontal footer-center bg-base-300 content-end p-8">
        <aside>
            <p class="font-mono text-lg">Made by Alex Sweeney</p>
            <p>
        ...
        <nav>
            <div class="grid grid-flow-col gap-4">
                <a href="https://github.com/ajs1998">
                    <svg 
                ...
                <a href="https://bsky.app/profile/alexjs.dev">
                ...
                <a href="https://www.youtube.com/@ajs1998/videos">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512"
                        class="fill-base-content"
                ...
                <a href="https://www.linkedin.com/in/alex-sweeney-a206301a8/">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 640 640"
                        class="fill-base-content"
